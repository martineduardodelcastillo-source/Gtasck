...
checks = {
    ...
    "pu_salary_share_m1_m6": ws["D14"].value,
    "net_m1_m6_month": ws["D15"].value,
    "gross_m7": ws["E13"].value,
    "pu_salary_share_m7": ws["E14"].value,
    "net_m7": ws["E15"].value,
    "gross_m8_m12_month": ws["F13"].value,
    "pu_salary_share_m8_m12": ws["F14"].value,
...
assert checks["pu_salary_share_m1_m6"] == -27000
assert checks["net_m1_m6_month"] == 87000
assert checks["gross_m7"] == 192500
assert checks["pu_salary_share_m7"] == -27000
assert checks["net_m7"] == 165500
assert checks["gross_m8_m12_month"] == 116000
assert checks["pu_salary_share_m8_m12"] == -27000
assert checks["net_m8_m12_month"] == 89000
assert checks["gross_year1"] == 1456500
assert checks["pu_salary_share_year1"] == -324000
assert checks["net_year1"] == 1132500
assert checks["alan_housing"] == 2000
assert checks["pu_share_alexander"] == "60%"
assert checks["pu_share_martin"] == "60%"
