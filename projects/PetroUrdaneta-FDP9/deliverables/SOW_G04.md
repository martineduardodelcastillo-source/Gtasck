# STATEMENT OF WORK (SOW) · MSA — Gate G-04
## Modelo de Rede Multifásica (Estacionário/Transiente + 4/6/8") · PetroUrdaneta FDP-9

| Campo | Valor |
|---|---|
| **SOW nº** | SOW-PU-G04-2026-001 |
| **MSA de referência** | MSA EPCM |
...
Construir o **modelo de rede multifásica** estacionário e transiente para fechamento do gate G-04, comparando diâmetros 4"/6"/8" por EPF/classe de trunk e definindo os envelopes das bombas multiphase.

**Incluído no escopo:**
- Modelo estacionário/transiente da rede (well→EPF→FSB)
...
Este SOW está em conformidade com o **FDP v9** e baseado no **work program** aprovado. Normas aplicáveis: API RP 14E, ASME B31.3/B31.8, NORSOK Z-CR007, COVENIN.

## 3. TABELA DE PREÇO POR UNIDADE (PRICE PER UNIT TABLE)

| Item | Descrição | Unidade | Qtd | Preço unit. (US$) | Total (US$) |
|---|---|---|---:|---:|---:|
| 3.1 | Mob/demob equipe de modelagem | lump sum | 1 | 50.000 | 50.000 |
...
|---|---|---|---|
| Estação de modelagem (OLGA/LEAP/PIPESIM) | licença transiente | [ano] | [data] |
...
|---|---:|---|---|
| Project Manager | 1 | dedicado | sim |
...
Este projeto é tratado como **AFE separado** (ver formulário AFE anexo). **AFE nº:** AFE-PU-G04-2026-001 · **Valor:** US$ 600.000.
