# AFE — Autorização para Despesa · Poço P-199A

| Campo | Valor |
|---|---|
| **AFE nº** | AFE-PU-2026-004 |
| **Poço** | P-199A (Campo La Paz, Venezuela) |
...
Reativar o poço P-199A e convertê-lo para elevação por **ESP**, visando **1.900 BOPD**. O poço é categoria 1 e faz parte da base de 1.388 BND.
...
| Payback simples do AFE | ~17 dias |
