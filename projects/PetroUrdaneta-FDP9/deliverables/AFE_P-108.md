# AFE — Autorização para Despesa · Poço P-108

| Campo | Valor |
|---|---|
| **AFE nº** | AFE-PU-2026-006 |
| **Poço** | P-108 (Campo La Paz, Venezuela) |
...
Reativar o poço P-108 e convertê-lo para elevação por **ESP**, visando **1.900 BOPD**. O poço é categoria 1 e faz parte da base de 1.388 BND.
