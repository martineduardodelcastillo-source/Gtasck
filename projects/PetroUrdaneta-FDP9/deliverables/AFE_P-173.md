# AFE — Autorização para Despesa · Poço P-173

| Campo | Valor |
|---|---|
| **AFE nº** | AFE-PU-2026-008 |
| **Poço** | P-173 (Campo La Paz, Venezuela) |
...
Reativar o poço P-173 e convertê-lo para elevação por **ESP**, visando **1.900 BOPD**. O poço é categoria 1 e faz parte da base de 1.388 BND.
...
| 10 | Contingência restrição (comunidade_acesso) | 282.000 |
| | **TOTAL AFE** | **US$ 2,329,100** |
...
| Payback simples do AFE | ~20 dias |
