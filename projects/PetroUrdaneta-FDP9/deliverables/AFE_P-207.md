# AFE — Autorização para Despesa · Poço P-207

| Campo | Valor |
|---|---|
| **AFE nº** | AFE-PU-2026-005 |
| **Poço** | P-207 (Campo La Paz, Venezuela) |
...
Reativar o poço P-207 e convertê-lo para elevação por **ESP**, visando **1.900 BOPD**. O poço é categoria 1 e faz parte da base de 1.388 BND.
